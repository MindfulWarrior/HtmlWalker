...
import htmlwalker.tag.base.ContentScriptTag;
import htmlwalker.visitor.ITagGenericVisitor;
import htmlwalker.visitor.ITagVoidVisitor;

/**
 * This class houses the HTML <b>&lt;style&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagStyle extends ContentScriptTag
{
	/**
	 * Constructor for housing a new <b>&lt;style&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagStyle(WalkerFactory factory) { super(factory, factory.createStyle()); }

	/**
	 * Constructor for housing an existing <b>&lt;style&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagStyle(WalkerFactory factory, Object tag) { super(factory, tag); }
