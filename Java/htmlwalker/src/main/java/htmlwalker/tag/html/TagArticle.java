...
/**
 * This class houses the HTML <b>&lt;article&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagArticle extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagArticle(WalkerFactory factory) { super(factory, factory.createArticle()); }

	/**
	 * Constructor for housing an existing <b>&lt;article&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagArticle(WalkerFactory factory, Object tag) { super(factory, tag); }
