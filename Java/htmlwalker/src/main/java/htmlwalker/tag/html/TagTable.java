...
/**
 * This class houses the HTML <b>&lt;table&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTable extends ContentContainerTag
{
	 ...
	 */
	public TagTable(WalkerFactory factory) { super(factory, factory.createTable()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;table&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTable(WalkerFactory factory, Object tag) { super(factory, tag); }
