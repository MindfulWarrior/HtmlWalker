...
/**
 * This class houses the HTML <b>&lt;th&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTh extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagTh(WalkerFactory factory) { super(factory, factory.createTh()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;th&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTh(WalkerFactory factory, Object tag) { super(factory, tag); }
