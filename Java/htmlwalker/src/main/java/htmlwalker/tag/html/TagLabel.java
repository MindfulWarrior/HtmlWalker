...
/**
 * This class houses the HTML <b>&lt;label&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagLabel extends ContentContainerTag
{
	 ...
	 */
	public TagLabel(WalkerFactory factory) { super(factory, factory.createLabel()); }

	/**
	 * Constructor for housing an existing <b>&lt;label&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagLabel(WalkerFactory factory, Object tag) { super(factory, tag); }
