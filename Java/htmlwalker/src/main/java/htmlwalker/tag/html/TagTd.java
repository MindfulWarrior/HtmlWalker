...
/**
 * This class houses the HTML <b>&lt;td&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTd extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagTd(WalkerFactory factory) { super(factory, factory.createTd()); }

	/**
	 * Constructor for housing an existing <b>&lt;td&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTd(WalkerFactory factory, Object tag) { super(factory, tag); }
