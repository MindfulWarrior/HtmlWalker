...
/**
 * This class houses the HTML <b>&lt;code&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagCode extends ContentContainerTag
{
	 ...
	 */
	public TagCode(WalkerFactory factory) { super(factory, factory.createCode()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;code&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagCode(WalkerFactory factory, Object tag) { super(factory, tag); }
