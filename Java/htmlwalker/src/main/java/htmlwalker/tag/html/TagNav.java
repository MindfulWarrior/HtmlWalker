...
/**
* This class houses the HTML <b>&lt;nav&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagNav extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagNav(WalkerFactory factory) { super(factory, factory.createNav()); }

	/**
	 * Constructor for housing an existing <b>&lt;nav&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagNav(WalkerFactory factory, Object tag) { super(factory, tag); }
