...
/**
 * This class houses the HTML <b>&lt;a&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagA extends ContentContainerTag
{
	/**
	 * Constructor for housing a new <b>&lt;a&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagA(WalkerFactory factory) { super(factory, factory.createA()); }

	/**
	 * Constructor for housing an existing <b>&lt;a&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - used to produce objects as per the specific platform
	 */
	public TagA(WalkerFactory factory, Object tag) { super(factory, tag); }
