...
/**
 * This class houses the HTML <b>&lt;u&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagU extends ContentContainerTag
{
	 ...
	 */
	public TagU(WalkerFactory factory) { super(factory, factory.createU()); }

	/**
	 * Constructor for housing an existing <b>&lt;u&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagU(WalkerFactory factory, Object tag) { super(factory, tag); }
