...
/**
 * This class houses the HTML <b>&lt;command&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagCommand extends ContentContainerTag
{
	 ...
	 */
	public TagCommand(WalkerFactory factory) { super(factory, factory.createCommand()); }

	/**
	 * Constructor for housing an existing <b>&lt;command&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagCommand(WalkerFactory factory, Object tag) { super(factory, tag); }
