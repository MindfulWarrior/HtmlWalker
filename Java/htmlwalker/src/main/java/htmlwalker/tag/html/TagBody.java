...
/**
 * This class houses the HTML <b>&lt;body&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagBody extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagBody(WalkerFactory factory) { super(factory, factory.createBody()); }

	/**
	 * Constructor for housing an existing <b>&lt;body&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagBody(WalkerFactory factory, Object tag) { super(factory, tag); }
