...
/**
 * This class houses the HTML <b>&lt;figcaption&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagFigcaption extends ContentContainerTag
{
	 ...
	 */
	public TagFigcaption(WalkerFactory factory) { super(factory, factory.createFigcaption()); }

	/**
	 * Constructor for housing an existing <b>&lt;figcaption&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagFigcaption(WalkerFactory factory, Object tag) { super(factory, tag); }
