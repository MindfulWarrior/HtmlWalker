...
/**
 * This class houses the HTML <b>&lt;header&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagHeader extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagHeader(WalkerFactory factory) { super(factory, factory.createHeader()); }

	/**
	 * Constructor for housing an existing <b>&lt;header&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagHeader(WalkerFactory factory, Object tag) { super(factory, tag); }
