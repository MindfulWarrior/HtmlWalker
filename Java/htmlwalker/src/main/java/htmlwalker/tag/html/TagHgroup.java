...
/**
 * This class houses the HTML <b>&lt;hgroup&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagHgroup extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagHgroup(WalkerFactory factory) { super(factory, factory.createHgroup()); }

	/**
	 * Constructor for housing an existing <b>&lt;hgroup&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagHgroup(WalkerFactory factory, Object tag) { super(factory, tag); }
