...
/**
 * This class houses the HTML <b>&lt;footer&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagFooter extends ContentContainerTag
{
	 ...
	 */
	public TagFooter(WalkerFactory factory) { super(factory, factory.createFooter()); }

	/**
	 * Constructor for housing an existing <b>&lt;footer&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagFooter(WalkerFactory factory, Object tag) { super(factory, tag); }
