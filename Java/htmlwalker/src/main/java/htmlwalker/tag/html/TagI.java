...
/**
 * This class houses the HTML <b>&lt;i&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagI extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagI(WalkerFactory factory) { super(factory, factory.createI()); }

	/**
	 * Constructor for housing an existing <b>&lt;i&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagI(WalkerFactory factory, Object tag) { super(factory, tag); }
