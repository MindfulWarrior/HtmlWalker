...
/**
 * This class houses the HTML <b>&lt;main&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagMain extends ContentContainerTag
{
	
	/**
	 * Constructor for housing a new <b>&lt;main&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagMain(WalkerFactory factory) { super(factory, factory.createMain()); }

	/**
	 * Constructor for housing an existing <b>&lt;main&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagMain(WalkerFactory factory, Object tag) { super(factory, tag); }
