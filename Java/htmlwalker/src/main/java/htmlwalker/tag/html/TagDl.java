...
/**
 * This class houses the HTML <b>&lt;dl&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagDl extends ContentContainerTag
{
	 ...
	 */
	public TagDl(WalkerFactory factory) { super(factory, factory.createDl()); }

	/**
	 * Constructor for housing an existing <b>&lt;dl&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagDl(WalkerFactory factory, Object tag) { super(factory, tag); }
