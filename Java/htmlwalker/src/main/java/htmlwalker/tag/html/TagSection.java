...
/**
* This class houses the HTML <b>&lt;section&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagSection extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSection(WalkerFactory factory) { super(factory, factory.createSection()); }

	/**
	 * Constructor for housing an existing <b>&lt;section&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSection(WalkerFactory factory, Object tag) { super(factory, tag); }
