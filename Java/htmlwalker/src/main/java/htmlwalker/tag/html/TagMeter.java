...
/**
* This class houses the HTML <b>&lt;meter&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagMeter extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagMeter(WalkerFactory factory) { super(factory, factory.createMeter()); }

	/**
	 * Constructor for housing an existing <b>&lt;meter&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagMeter(WalkerFactory factory, Object tag) { super(factory, tag); }
