...
/**
 * This class houses the HTML <b>&lt;video&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagVideo extends ContentContainerTag
{	
	/**
	 ...
	 */
	public TagVideo(WalkerFactory factory) { super(factory, factory.createVideo()); }

	/**
	 * Constructor for housing an existing <b>&lt;video&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagVideo(WalkerFactory factory, Object tag) { super(factory, tag); }
