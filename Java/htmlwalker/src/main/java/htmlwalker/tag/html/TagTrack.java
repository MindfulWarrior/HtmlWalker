...
/**
 * This class houses the HTML <b>&lt;track&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTrack extends ContentNoneTag
{
	/**
	 ...
	 */
	public TagTrack(WalkerFactory factory) { super(factory, factory.createTrack()); }

	/**
	 * Constructor for housing an existing <b>&lt;track&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTrack(WalkerFactory factory, Object tag) { super(factory, tag); }
