...
/**
 * This class houses the HTML <b>&lt;summary&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagSummary extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSummary(WalkerFactory factory) { super(factory, factory.createSummary()); }

	/**
	 * Constructor for housing an existing <b>&lt;summary&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSummary(WalkerFactory factory, Object tag) { super(factory, tag); }
