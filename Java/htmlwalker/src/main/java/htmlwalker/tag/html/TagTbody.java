...
/**
 * This class houses the HTML <b>&lt;tbody&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTbody extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagTbody(WalkerFactory factory) { super(factory, factory.createTbody()); }

	/**
	 * Constructor for housing an existing <b>&lt;tbody&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTbody(WalkerFactory factory, Object tag) { super(factory, tag); }
