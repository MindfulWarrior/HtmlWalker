...
/**
 * This class houses the HTML <b>&lt;tr&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagTr extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagTr(WalkerFactory factory) { super(factory, factory.createTr()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;tr&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagTr(WalkerFactory factory, Object tag) { super(factory, tag); }
