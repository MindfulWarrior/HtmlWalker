...
/**
 * This class houses the HTML <b>&lt;ins&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagIns extends ContentContainerTag
{
	 ...
	 */
	public TagIns(WalkerFactory factory) { super(factory, factory.createIns()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;ins&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagIns(WalkerFactory factory, Object tag) { super(factory, tag); }
