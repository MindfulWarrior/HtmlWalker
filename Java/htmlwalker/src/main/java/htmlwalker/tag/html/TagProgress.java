...
/**
* This class houses the HTML <b>&lt;progress&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagProgress extends ContentNoneTag
{
	/**
	 ...
	 */
	public TagProgress(WalkerFactory factory) { super(factory, factory.createProgress()); }

	/**
	 * Constructor for housing an existing <b>&lt;progress&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagProgress(WalkerFactory factory, Object tag) { super(factory, tag); }
