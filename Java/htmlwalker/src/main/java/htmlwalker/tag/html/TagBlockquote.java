...
/**
 * This class houses the HTML <b>&lt;blockquote&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagBlockquote extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagBlockquote(WalkerFactory factory) { super(factory, factory.createBlockquote()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;blockquote&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagBlockquote(WalkerFactory factory, Object tag) { super(factory, tag); }
