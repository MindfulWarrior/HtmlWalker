...
/**
 * This class houses the HTML <b>&lt;form&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagForm extends ContentContainerTag
{
	 ...
	 */
	public TagForm(WalkerFactory factory) { super(factory, factory.createForm()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;form&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagForm(WalkerFactory factory, Object tag) { super(factory, tag); }
