...
/**
 * This class houses the HTML <b>&lt;col&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagCol extends ContentContainerTag
{
	 ...
	 */
	public TagCol(WalkerFactory factory) { super(factory, factory.createCol()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;col&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagCol(WalkerFactory factory, Object tag) { super(factory, tag); }
