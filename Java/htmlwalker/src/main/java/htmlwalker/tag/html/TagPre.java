...
/**
* This class houses the HTML <b>&lt;pre&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagPre extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagPre(WalkerFactory factory) { super(factory, factory.createPre()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;pre&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagPre(WalkerFactory factory, Object tag) { super(factory, tag); }
