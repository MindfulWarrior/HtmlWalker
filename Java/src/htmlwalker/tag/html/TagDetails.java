...
/**
 * This class houses the HTML <b>&lt;details&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagDetails extends ContentContainerTag
{
	 ...
	 */
	public TagDetails(WalkerFactory factory) { super(factory, factory.createDetails()); }

	/**
	 * Constructor for housing an existing <b>&lt;details&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagDetails(WalkerFactory factory, Object tag) { super(factory, tag); }
