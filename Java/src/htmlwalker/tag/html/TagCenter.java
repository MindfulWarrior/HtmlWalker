...
/**
 * This class houses the HTML <b>&lt;center&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagCenter extends ContentContainerTag
{
	 ...
	 */
	public TagCenter(WalkerFactory factory) { super(factory, factory.createCenter()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;center&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagCenter(WalkerFactory factory, Object tag) { super(factory, tag); }
