...
/**
 * This class houses the HTML <b>&lt;abbr&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagAbbr extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagAbbr(WalkerFactory factory) { super(factory, factory.createAbbr()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;abbr&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagAbbr(WalkerFactory factory, Object tag) { super(factory, tag); }
