...
/**
* This class houses the HTML <b>&lt;ruby&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagRuby extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagRuby(WalkerFactory factory) { super(factory, factory.createRuby()); }

	/**
	 * Constructor for housing an existing <b>&lt;ruby&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagRuby(WalkerFactory factory, Object tag) { super(factory, tag); }
