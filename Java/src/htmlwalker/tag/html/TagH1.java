...
/**
 * This class houses the HTML <b>&lt;h1&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagH1 extends ContentContainerTag
{
	 ...
	 */
	public TagH1(WalkerFactory factory) { super(factory, factory.createH1()); }

	/**
	 * Constructor for housing an existing <b>&lt;h1&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagH1(WalkerFactory factory, Object tag) { super(factory, tag); }
