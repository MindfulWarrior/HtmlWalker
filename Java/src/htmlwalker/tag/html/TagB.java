...
/**
 * This class houses the HTML <b>&lt;b&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagB extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagB(WalkerFactory factory) { super(factory, factory.createB()); }

	/**
	 * Constructor for housing an existing <b>&lt;b&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagB(WalkerFactory factory, Object tag) { super(factory, tag); }
