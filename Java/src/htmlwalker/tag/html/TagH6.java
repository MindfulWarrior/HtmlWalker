...
/**
 * This class houses the HTML <b>&lt;h6&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagH6 extends ContentContainerTag
{
	 ...
	 */
	public TagH6(WalkerFactory factory) { super(factory, factory.createH6()); }

	/**
	 * Constructor for housing an existing <b>&lt;h6&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagH6(WalkerFactory factory, Object tag) { super(factory, tag); }
