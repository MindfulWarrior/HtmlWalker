...
/**
* This class houses the HTML <b>&lt;select&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagSelect extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSelect(WalkerFactory factory) { super(factory, factory.createSelect()); }

	/**
	 * Constructor for housing an existing <b>&lt;select&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSelect(WalkerFactory factory, Object tag) { super(factory, tag); }
