...
/**
 * This class houses the HTML <b>&lt;address&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagAddress extends ContentContainerTag
{
	/**
	 * Constructor for housing a new <b>&lt;address&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagAddress(WalkerFactory factory) { super(factory, factory.createAddress()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;address&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagAddress(WalkerFactory factory, Object tag) { super(factory, tag); }
