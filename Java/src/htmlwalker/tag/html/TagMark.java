...
/**
* This class houses the HTML <b>&lt;mark&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagMark extends ContentContainerTag
{
	/**
	 * Constructor for housing a new <b>&lt;mark&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagMark(WalkerFactory factory) { super(factory, factory.createMark()); }

	/**
	 * Constructor for housing an existing <b>&lt;mark&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagMark(WalkerFactory factory, Object tag) { super(factory, tag); }
