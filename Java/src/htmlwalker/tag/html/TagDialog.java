...
/**
 * This class houses the HTML <b>&lt;dialog&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagDialog extends ContentContainerTag
{
	 ...
	 */
	public TagDialog(WalkerFactory factory) { super(factory, factory.createDialog()); }

	/**
	 * Constructor for housing an existing <b>&lt;dialog&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagDialog(WalkerFactory factory, Object tag) { super(factory, tag); }
