...
/**
 * This class houses the HTML <b>&lt;ul&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagUl extends ContentContainerTag
{
	 ...
	 */
	public TagUl(WalkerFactory factory) { super(factory, factory.createUl()); }

	/**
	 * Constructor for housing an existing <b>&lt;ul&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagUl(WalkerFactory factory, Object tag) { super(factory, tag); }
