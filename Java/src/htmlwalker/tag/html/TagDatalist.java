...
/**
 * This class houses the HTML <b>&lt;datalist&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagDatalist extends ContentContainerTag
{
	 ...
	 */
	public TagDatalist(WalkerFactory factory) { super(factory, factory.createDatalist()); }

	/**
	 * Constructor for housing an existing <b>&lt;datalist&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagDatalist(WalkerFactory factory, Object tag) { super(factory, tag); }
