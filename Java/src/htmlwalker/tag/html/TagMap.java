...
/**
 * This class houses the HTML <b>&lt;map&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagMap extends ContentContainerTag
{
	 ...
	 */
	public TagMap(WalkerFactory factory) { super(factory, factory.createMap()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;map&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagMap(WalkerFactory factory, Object tag) { super(factory, tag); }
