...
/**
 * This class houses the HTML <b>&lt;span&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagSpan extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSpan(WalkerFactory factory) { super(factory, factory.createSpan()); }

	/**
	 * Constructor for housing an existing <b>&lt;span&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSpan(WalkerFactory factory, Object tag) { super(factory, tag); }
