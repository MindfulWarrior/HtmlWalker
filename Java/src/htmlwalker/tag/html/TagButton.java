...
/**
 * This class houses the HTML <b>&lt;button&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagButton extends ContentContainerTag
{
	 ...
	 */
	public TagButton(WalkerFactory factory) { super(factory, factory.createButton()); }

	/**
	 * Constructor for housing an existing <b>&lt;button&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagButton(WalkerFactory factory, Object tag) { super(factory, tag); }
