...
/**
 * This class houses the HTML <b>&lt;kbd&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagKbd extends ContentContainerTag
{
	 ...
	 */
	public TagKbd(WalkerFactory factory) { super(factory, factory.createKbd()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;kbd&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagKbd(WalkerFactory factory, Object tag) { super(factory, tag); }
