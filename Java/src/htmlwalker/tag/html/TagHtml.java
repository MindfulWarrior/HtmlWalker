...
/**
 * This class houses the HTML <b>&lt;html&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagHtml extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagHtml(WalkerFactory factory) { super(factory, factory.createHtml()); } 

	/**
	 * Constructor for housing an existing <b>&lt;html&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagHtml(WalkerFactory factory, Object tag) { super(factory, tag); } 
