...
/**
* This class houses the HTML <b>&lt;s&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagS extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagS(WalkerFactory factory) { super(factory, factory.createS()); }

	/**
	 * Constructor for housing an existing <b>&lt;s&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagS(WalkerFactory factory, Object tag) { super(factory, tag); }
