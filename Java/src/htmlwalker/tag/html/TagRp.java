...
/**
* This class houses the HTML <b>&lt;rp&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagRp extends ContentContainerTag
{
	/**
	 * Constructor for housing a new <b>&lt;rp&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagRp(WalkerFactory factory) { super(factory, factory.createRp()); }

	/**
	 * Constructor for housing an existing <b>&lt;rp&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagRp(WalkerFactory factory, Object tag) { super(factory, tag); }
