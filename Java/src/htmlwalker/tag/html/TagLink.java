...
/**
 * This class houses the HTML <b>&lt;link&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagLink extends ContentNoneTag
{
	 ...
	 */
	public TagLink(WalkerFactory factory) { super(factory, factory.createLink()); }

	/**
	 * Constructor for housing an existing <b>&lt;link&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagLink(WalkerFactory factory, Object tag) { super(factory, tag); }
