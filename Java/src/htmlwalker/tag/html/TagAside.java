...
/**
 * This class houses the HTML <b>&lt;aside&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagAside extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagAside(WalkerFactory factory) { super(factory, factory.createAside()); }

	/**
	 * Constructor for housing an existing <b>&lt;aside&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagAside(WalkerFactory factory, Object tag) { super(factory, tag); }
