...
/**
* This class houses the HTML <b>&lt;small&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagSmall extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSmall(WalkerFactory factory) { super(factory, factory.createSmall()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;small&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSmall(WalkerFactory factory, Object tag) { super(factory, tag); }
