...
/**
 * This class houses the HTML <b>&lt;font&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagFont extends ContentContainerTag
{ 
	 ...
	 */
	public TagFont(WalkerFactory factory) { super(factory, factory.createFont()); }

	/**
	 * Constructor for housing an existing <b>&lt;font&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagFont(WalkerFactory factory, Object tag) { super(factory, tag); }
