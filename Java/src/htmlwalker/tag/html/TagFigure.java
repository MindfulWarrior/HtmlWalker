...
/**
 * This class houses the HTML <b>&lt;figure&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagFigure extends ContentContainerTag
{
	
	/**
	 * Constructor for housing a new <b>&lt;figure&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagFigure(WalkerFactory factory) { super(factory, factory.createFigure()); }

	/**
	 * Constructor for housing an existing <b>&lt;figure&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagFigure(WalkerFactory factory, Object tag) { super(factory, tag); }
