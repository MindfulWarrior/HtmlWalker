...
/**
 * This class houses the HTML <b>&lt;sub&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagSub extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagSub(WalkerFactory factory) { super(factory, factory.createSub()); }

	/**
	 * Constructor for housing an existing <b>&lt;sub&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSub(WalkerFactory factory, Object tag) { super(factory, tag); }
