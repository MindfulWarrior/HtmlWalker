...
/**
 * This class houses the HTML <b>&lt;legend&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagLegend extends ContentContainerTag
{
	
	/**
	 * Constructor for housing a new <b>&lt;legend&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagLegend(WalkerFactory factory) { super(factory, factory.createLegend()); }
	

	/**
	 * Constructor for housing an existing <b>&lt;legend&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagLegend(WalkerFactory factory, Object tag) { super(factory, tag); }
