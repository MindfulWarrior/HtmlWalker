...
/**
 * This class houses the HTML <b>&lt;dd&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagDd extends ContentContainerTag
{
	 ...
	 */
	public TagDd(WalkerFactory factory) { super(factory, factory.createDd()); }

	/**
	 * Constructor for housing an existing <b>&lt;dd&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagDd(WalkerFactory factory, Object tag) { super(factory, tag); }
