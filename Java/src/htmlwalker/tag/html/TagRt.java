...
/**
* This class houses the HTML <b>&lt;rt&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagRt extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagRt(WalkerFactory factory) { super(factory, factory.createRt()); }

	/**
	 * Constructor for housing an existing <b>&lt;rt&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagRt(WalkerFactory factory, Object tag) { super(factory, tag); }
