...
/**
* This class houses the HTML <b>&lt;noscript&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagNoscript extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagNoscript(WalkerFactory factory) { super(factory, factory.createNoscript()); }

	/**
	 * Constructor for housing an existing <b>&lt;noscript&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagNoscript(WalkerFactory factory, Object tag) { super(factory, tag); }
