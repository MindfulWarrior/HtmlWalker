...
/**
 * This class houses the HTML <b>&lt;iframe&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagIframe extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagIframe(WalkerFactory factory) { super(factory, factory.createIframe()); }
	 ...
	 */
	public TagIframe(WalkerFactory factory, Object tag) { super(factory, tag); }
