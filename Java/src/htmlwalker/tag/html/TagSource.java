...
/**
 * This class houses the HTML <b>&lt;source&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagSource extends ContentNoneTag
{
	/**
	 ...
	 */
	public TagSource(WalkerFactory factory) { super(factory, factory.createSource()); }

	/**
	 * Constructor for housing an existing <b>&lt;source&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagSource(WalkerFactory factory, Object tag) { super(factory, tag); }
