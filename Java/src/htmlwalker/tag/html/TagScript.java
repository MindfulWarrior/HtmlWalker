...
/**
* This class houses the HTML <b>&lt;script&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagScript extends ContentScriptTag
{
	/**
	 ...
	 */
	public TagScript(WalkerFactory factory) { super(factory, factory.createScript()); }

	/**
	 * Constructor for housing an existing <b>&lt;script&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagScript(WalkerFactory factory, Object tag) { super(factory, tag); }
