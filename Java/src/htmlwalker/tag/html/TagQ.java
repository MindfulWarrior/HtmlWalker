...
/**
* This class houses the HTML <b>&lt;q&gt;</b> tag object and provides the ITag interface.
* 
* @author Robert Flores
* @see HtmlWalker.ITag
*/
public class TagQ extends ContentContainerTag
{
	/**
	 * Constructor for housing a new <b>&lt;q&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 */
	public TagQ(WalkerFactory factory) { super(factory, factory.createQ()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;q&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagQ(WalkerFactory factory, Object tag) { super(factory, tag); }
