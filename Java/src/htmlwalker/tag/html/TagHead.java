...
/**
 * This class houses the HTML <b>&lt;head&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagHead extends ContentContainerTag
{
	/**
	 ...
	 */
	public TagHead(WalkerFactory factory) { super(factory, factory.createHead()); }

	/**
	 * Constructor for housing an existing <b>&lt;head&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagHead(WalkerFactory factory, Object tag) { super(factory, tag); }
