...
/**
 * This class houses the HTML <b>&lt;colgroup&gt;</b> tag object and provides the ITag interface.
 * 
 * @author Robert Flores
 * @see HtmlWalker.ITag
 */
public class TagColgroup extends ContentContainerTag
{
	 ...
	 */
	public TagColgroup(WalkerFactory factory) { super(factory, factory.createColgroup()); }
	
	/**
	 * Constructor for housing an existing <b>&lt;colgroup&gt;</b> tag.
	 *
	 * @param factory - used to produce objects as per the specific platform
	 * @param tag - object housed by this tag adapter
	 */
	public TagColgroup(WalkerFactory factory, Object tag) { super(factory, tag); }
