...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;datalist&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDatalist : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;datalist&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagDatalist(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDatalist()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;datalist&gt;</b> tag
        /// </summary>
        ...
        public TagDatalist(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
