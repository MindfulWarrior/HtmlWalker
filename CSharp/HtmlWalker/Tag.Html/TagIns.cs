...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;ins&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagIns : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;ins&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagIns(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateIns()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;ins&gt;</b> tag
        /// </summary>
        ...
        public TagIns(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
