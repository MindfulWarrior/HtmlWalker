...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;menu&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagMenu : ContentContainerTag
    {
        /// <summary>
        ...
        public TagMenu(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
