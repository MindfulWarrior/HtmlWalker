...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;rp&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagRp : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagRp(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateRp()) { }
