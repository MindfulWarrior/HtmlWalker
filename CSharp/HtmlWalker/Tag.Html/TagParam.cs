...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;param&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagParam : ContentNoneTag
    {
        /// <summary>
        ...
        /// </param>
        public TagParam(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateParam()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;param&gt;</b> tag
        /// </summary>
        ...
        public TagParam(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
