...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;picture&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagPicture : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;picture&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagPicture(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreatePicture()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;picture&gt;</b> tag
        /// </summary>
        ...
        public TagPicture(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
