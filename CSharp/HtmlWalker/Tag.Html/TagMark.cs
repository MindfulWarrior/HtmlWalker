...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;mark&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagMark : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagMark(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateMark()) { }
        ...
        public TagMark(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
