...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;base&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagBase : ContentNoneTag
    {
        /// <summary>
        ...
        /// </param>
        public TagBase(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateBase()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;base&gt;</b> tag
        /// </summary>
        ...
        public TagBase(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
