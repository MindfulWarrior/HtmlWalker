...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;track&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTrack : ContentNoneTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;track&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTrack(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTrack()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;track&gt;</b> tag
        /// </summary>
        ...
        public TagTrack(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
