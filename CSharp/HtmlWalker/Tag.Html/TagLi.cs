...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;li&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagLi : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagLi(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateLi()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;li&gt;</b> tag
        /// </summary>
        ...
        public TagLi(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
