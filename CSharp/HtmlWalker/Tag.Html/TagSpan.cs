...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;span&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSpan : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;span&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSpan(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSpan()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;span&gt;</b> tag
        /// </summary>
        ...
        public TagSpan(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
