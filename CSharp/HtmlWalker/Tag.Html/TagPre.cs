...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;pre&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagPre : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;pre&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagPre(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreatePre()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;pre&gt;</b> tag
        /// </summary>
        ...
        public TagPre(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
