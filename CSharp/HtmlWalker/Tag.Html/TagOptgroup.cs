...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;optgroup&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagOptgroup : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagOptgroup(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateOptgroup()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;optgroup&gt;</b> tag
        /// </summary>
        ...
        public TagOptgroup(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
