...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;strong&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ...
    public class TagStrong : ContentContainerTag
    {
        ...
        /// </param>
        public TagStrong(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateStrong()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;strong&gt;</b> tag
        /// </summary>
        ...
        public TagStrong(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
