...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;input&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagInput : ContentNoneTag
    {
        /// <summary>
        ...
        /// </param>
        public TagInput(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateInput()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;input&gt;</b> tag
        /// </summary>
        ...
        public TagInput(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
