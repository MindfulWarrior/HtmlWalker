...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;label&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagLabel : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;label&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagLabel(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateLabel()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;label&gt;</b> tag
        /// </summary>
        ...
        public TagLabel(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
