...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;small&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSmall : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;small&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSmall(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSmall()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;small&gt;</b> tag
        /// </summary>
        ...
        public TagSmall(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
