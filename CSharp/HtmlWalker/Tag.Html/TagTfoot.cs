...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;tfoot&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTfoot : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagTfoot(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTfoot()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;tfoot&gt;</b> tag
        /// </summary>
        ...
        public TagTfoot(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
