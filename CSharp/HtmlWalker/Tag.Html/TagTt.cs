...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;tt&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ...
    public class TagTt : ContentContainerTag
    {
        ...
        public TagTt(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
