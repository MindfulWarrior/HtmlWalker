...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;sub&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSub : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;sub&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSub(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSub()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;sub&gt;</b> tag
        /// </summary>
        ...
        public TagSub(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
