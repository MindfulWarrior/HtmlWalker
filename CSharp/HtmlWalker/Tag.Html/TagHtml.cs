...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;html&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagHtml : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;html&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagHtml(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateHtml()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;html&gt;</b> tag
        /// </summary>
        ...
        public TagHtml(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
