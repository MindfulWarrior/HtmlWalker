...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;h1&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagH1 : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;h1&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagH1(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateH1()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;h1&gt;</b> tag
        /// </summary>
        ...
        public TagH1(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
