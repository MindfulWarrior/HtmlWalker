...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;audio&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagAudio : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;audio&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagAudio(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateAudio()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;audio&gt;</b> tag
        /// </summary>
        ...
        public TagAudio(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
