...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;menuitem&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagMenuitem : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;menuitem&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagMenuitem(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateMenuitem()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;menuitem&gt;</b> tag
        /// </summary>
        ...
        public TagMenuitem(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
