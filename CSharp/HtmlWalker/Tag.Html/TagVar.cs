...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;var&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagVar : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagVar(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateVar()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;var&gt;</b> tag
        /// </summary>
        ...
        public TagVar(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
