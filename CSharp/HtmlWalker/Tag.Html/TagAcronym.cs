...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;acronym&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagAcronym : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;acronym&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagAcronym(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateAcronym()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;acronym&gt;</b> tag
        /// </summary>
        ...
        public TagAcronym(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
