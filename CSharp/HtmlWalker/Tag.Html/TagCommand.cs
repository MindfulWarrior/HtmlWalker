...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;command&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCommand : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;command&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagCommand(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCommand()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;command&gt;</b> tag
        /// </summary>
        ...
        public TagCommand(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
