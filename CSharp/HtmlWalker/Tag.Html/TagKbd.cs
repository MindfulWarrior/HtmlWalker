...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;kbd&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagKbd : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;kbd&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagKbd(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateKbd()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;kbd&gt;</b> tag
        /// </summary>
        ...
        public TagKbd(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
