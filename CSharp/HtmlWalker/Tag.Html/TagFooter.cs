...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;footer&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagFooter : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;footer&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagFooter(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateFooter()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;footer&gt;</b> tag
        /// </summary>
        ...
        public TagFooter(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
