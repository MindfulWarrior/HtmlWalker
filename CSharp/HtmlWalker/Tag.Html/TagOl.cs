...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;ol&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagOl : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagOl(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateOl()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;ol&gt;</b> tag
        /// </summary>
        ...
        public TagOl(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
