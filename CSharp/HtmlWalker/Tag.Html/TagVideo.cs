...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;video&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagVideo : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;video&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagVideo(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateVideo()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;video&gt;</b> tag
        /// </summary>
        ...
        public TagVideo(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
