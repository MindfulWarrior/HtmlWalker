...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;details&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDetails : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;details&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagDetails(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDetails()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;details&gt;</b> tag
        /// </summary>
        ...
        public TagDetails(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
