...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;source&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSource : ContentNoneTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;source&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSource(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSource()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;source&gt;</b> tag
        /// </summary>
        ...
        public TagSource(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
