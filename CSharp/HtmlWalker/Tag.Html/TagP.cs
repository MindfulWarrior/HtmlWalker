...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;p&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagP : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagP(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateP()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;p&gt;</b> tag
        /// </summary>
        ...
        public TagP(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
