...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;keygen&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagKeygen : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagKeygen(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateKeygen()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;keygen&gt;</b> tag
        /// </summary>
        ...
        public TagKeygen(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
