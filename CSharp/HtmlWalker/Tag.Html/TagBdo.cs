...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;bdo&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagBdo : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagBdo(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateBdo()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;bdo&gt;</b> tag
        /// </summary>
        ...
        public TagBdo(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
