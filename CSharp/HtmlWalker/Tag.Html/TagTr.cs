...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;tr&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTr : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;tr&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTr(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTr()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;tr&gt;</b> tag
        /// </summary>
        ...
        public TagTr(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
