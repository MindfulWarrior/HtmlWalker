...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;table&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTable : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;table&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTable(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTable()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;table&gt;</b> tag
        /// </summary>
        ...
        public TagTable(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
