...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;dd&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDd : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;dd&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagDd(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDd()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;dd&gt;</b> tag
        /// </summary>
        ...
        public TagDd(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
