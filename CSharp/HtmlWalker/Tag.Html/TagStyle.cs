...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;style&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentScriptTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagStyle : ContentScriptTag
    {
        /// <summary>
        ...
        /// </param>
        public TagStyle(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateStyle()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;style&gt;</b> tag
        /// </summary>
        ...
        public TagStyle(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
