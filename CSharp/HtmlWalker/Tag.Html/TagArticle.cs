...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;article&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagArticle : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;article&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagArticle(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateArticle()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;article&gt;</b> tag
        /// </summary>
        ...
        public TagArticle(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
