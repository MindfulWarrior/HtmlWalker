...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;section&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSection : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;section&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSection(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSection()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;section&gt;</b> tag
        /// </summary>
        ...
        public TagSection(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
