...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;noscript&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagNoscript : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;noscript&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagNoscript(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateNoscript()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;noscript&gt;</b> tag
        /// </summary>
        ...
        public TagNoscript(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
