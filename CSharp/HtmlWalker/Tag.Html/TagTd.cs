...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;td&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTd : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;td&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTd(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTd()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;td&gt;</b> tag
        /// </summary>
        ...
        public TagTd(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
