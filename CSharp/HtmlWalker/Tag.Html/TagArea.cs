...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;area&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagArea : ContentNoneTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;area&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagArea(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateArea()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;area&gt;</b> tag
        /// </summary>
        ...
        public TagArea(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
