...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;caption&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCaption : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagCaption(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCaption()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;caption&gt;</b> tag
        /// </summary>
        ...
        public TagCaption(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
