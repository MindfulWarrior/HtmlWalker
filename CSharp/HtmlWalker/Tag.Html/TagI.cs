...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;i&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagI : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;i&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagI(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateI()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;i&gt;</b> tag
        /// </summary>
        ...
        public TagI(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
