...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;u&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagU : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;u&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagU(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateU()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;u&gt;</b> tag
        /// </summary>
        ...
        public TagU(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
