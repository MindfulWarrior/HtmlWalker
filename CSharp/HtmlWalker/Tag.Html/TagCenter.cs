...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;center&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCenter : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;center&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagCenter(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCenter()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;center&gt;</b> tag
        /// </summary>
        ...
        public TagCenter(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
