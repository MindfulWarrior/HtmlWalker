...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;abbr&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagAbbr : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;abbr&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagAbbr(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateAbbr()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;abbr&gt;</b> tag
        /// </summary>
        ...
        public TagAbbr(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
