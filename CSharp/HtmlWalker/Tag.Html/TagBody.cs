...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;body&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagBody : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;body&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagBody(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateBody()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;body&gt;</b> tag
        /// </summary>
        ...
        public TagBody(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
