...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;bdi&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagBdi : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagBdi(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateBdi()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;bdi&gt;</b> tag
        /// </summary>
        ...
        public TagBdi(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
