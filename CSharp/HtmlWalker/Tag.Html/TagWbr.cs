...
namespace HtmlWalker.Tag.Html
{
    ...
    public class TagWbr : ContentNoneTag
    {
        ...
        /// </param>
        public TagWbr(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateWbr()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;wbr&gt;</b> tag
        /// </summary>
        ...
        public TagWbr(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
