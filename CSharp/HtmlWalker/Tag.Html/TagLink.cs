...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;link&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagLink : ContentNoneTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;link&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagLink(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateLink()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;link&gt;</b> tag
        /// </summary>
        ...
        public TagLink(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
