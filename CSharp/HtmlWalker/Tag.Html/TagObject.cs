...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;object&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagObject : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagObject(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateObject()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;object&gt;</b> tag
        /// </summary>
        ...
        public TagObject(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
