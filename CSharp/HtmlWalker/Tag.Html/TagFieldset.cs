...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;fieldset&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagFieldset : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagFieldset(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateFieldset()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;fieldset&gt;</b> tag
        /// </summary>
        ...
        public TagFieldset(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
