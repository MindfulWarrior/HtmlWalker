...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;form&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagForm : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;form&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagForm(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateForm()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;form&gt;</b> tag
        /// </summary>
        ...
        public TagForm(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
