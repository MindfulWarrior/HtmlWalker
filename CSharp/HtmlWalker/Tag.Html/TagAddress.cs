...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;address&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagAddress : ContentContainerTag
    {
        /// <summary>
        ...
        public TagAddress(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
