...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;meter&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagMeter : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;meter&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagMeter(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateMeter()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;meter&gt;</b> tag
        /// </summary>
        ...
        public TagMeter(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
