...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;button&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagButton : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;button&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagButton(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateButton()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;button&gt;</b> tag
        /// </summary>
        ...
        public TagButton(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
