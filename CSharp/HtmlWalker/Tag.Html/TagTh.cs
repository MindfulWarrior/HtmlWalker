...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;th&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTh : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;th&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTh(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTh()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;th&gt;</b> tag
        /// </summary>
        ...
        public TagTh(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
