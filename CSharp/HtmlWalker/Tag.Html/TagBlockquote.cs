...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;blockquote&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagBlockquote : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;blockquote&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagBlockquote(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateBlockquote()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;blockquote&gt;</b> tag
        /// </summary>
        ...
        public TagBlockquote(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
