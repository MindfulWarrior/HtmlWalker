...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;embed&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagEmbed : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagEmbed(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateEmbed()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;embed&gt;</b> tag
        /// </summary>
        ...
        public TagEmbed(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
