...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;tbody&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTbody : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;tbody&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagTbody(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTbody()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;tbody&gt;</b> tag
        /// </summary>
        ...
        public TagTbody(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
