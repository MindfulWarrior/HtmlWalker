...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;ul&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagUl : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;ul&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagUl(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateUl()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;ul&gt;</b> tag
        /// </summary>
        ...
        public TagUl(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
