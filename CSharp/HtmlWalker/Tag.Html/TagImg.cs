...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;img&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagImg : ContentNoneTag
    {
        /// <summary>
        ...
        /// </param>
        public TagImg(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateImg()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;img&gt;</b> tag
        /// </summary>
        ...
        public TagImg(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
