...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;s&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagS : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;s&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagS(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateS()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;s&gt;</b> tag
        /// </summary>
        ...
        public TagS(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
