...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;cite&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCite : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagCite(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCite()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;cite&gt;</b> tag
        /// </summary>
        ...
        public TagCite(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
