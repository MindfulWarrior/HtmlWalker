...
namespace HtmlWalker.Tag.Html
{
    ...
    public class TagA : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagA(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateA()) { }
        ...
        public TagA(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
