...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;div&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDiv : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagDiv(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDiv()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;div&gt;</b> tag
        /// </summary>
        ...
        public TagDiv(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
