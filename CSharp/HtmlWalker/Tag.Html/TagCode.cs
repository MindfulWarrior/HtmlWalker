...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;code&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCode : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;code&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagCode(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCode()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;code&gt;</b> tag
        /// </summary>
        ...
        public TagCode(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
