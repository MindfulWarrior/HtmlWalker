...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;dfn&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDfn : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagDfn(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDfn()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;dfn&gt;</b> tag
        /// </summary>
        ...
        public TagDfn(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
