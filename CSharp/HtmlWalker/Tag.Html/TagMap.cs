...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;map&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagMap : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;map&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagMap(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateMap()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;map&gt;</b> tag
        /// </summary>
        ...
        public TagMap(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
