...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;progress&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagProgress : ContentNoneTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;progress&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagProgress(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateProgress()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;progress&gt;</b> tag
        /// </summary>
        ...
        public TagProgress(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
