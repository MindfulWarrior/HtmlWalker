...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;iframe&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagIframe : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;iframe&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagIframe(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateIframe()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;iframe&gt;</b> tag
        /// </summary>
        ...
        public TagIframe(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
