...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;textarea&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentTextTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagTextarea : ContentTextTag
    {
        /// <summary>
        ...
        /// </param>
        public TagTextarea(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTextarea()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;textarea&gt;</b> tag
        /// </summary>
        ...
        public TagTextarea(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
