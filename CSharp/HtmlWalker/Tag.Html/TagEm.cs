...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;em&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagEm : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagEm(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateEm()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;em&gt;</b> tag
        /// </summary>
        ...
        public TagEm(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
