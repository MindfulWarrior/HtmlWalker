...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;head&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagHead : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;head&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagHead(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateHead()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;head&gt;</b> tag
        /// </summary>
        ...
        public TagHead(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
