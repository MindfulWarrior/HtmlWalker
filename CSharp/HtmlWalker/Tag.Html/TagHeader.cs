...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;header&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagHeader : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;header&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagHeader(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateHeader()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;header&gt;</b> tag
        /// </summary>
        ...
        public TagHeader(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
