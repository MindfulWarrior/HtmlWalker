...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;b&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagB : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagB(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateB()) { }
        ...
        public TagB(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
