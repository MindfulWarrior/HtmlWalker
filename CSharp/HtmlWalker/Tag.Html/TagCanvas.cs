...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;canvas&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCanvas : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagCanvas(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCanvas()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;canvas&gt;</b> tag
        /// </summary>
        ...
        public TagCanvas(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
