...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;rt&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagRt : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;rt&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagRt(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateRt()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;rt&gt;</b> tag
        /// </summary>
        ...
        public TagRt(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
