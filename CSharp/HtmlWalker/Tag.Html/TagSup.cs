...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;sup&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSup : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagSup(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSup()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;sup&gt;</b> tag
        /// </summary>
        ...
        public TagSup(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
