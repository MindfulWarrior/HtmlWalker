...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;hgroup&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagHgroup : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;hgroup&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagHgroup(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateHgroup()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;hgroup&gt;</b> tag
        /// </summary>
        ...
        public TagHgroup(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
