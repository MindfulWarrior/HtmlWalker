...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;col&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagCol : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;col&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagCol(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateCol()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;col&gt;</b> tag
        /// </summary>
        ...
        public TagCol(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
