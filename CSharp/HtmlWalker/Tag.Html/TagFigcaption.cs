...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;figcaption&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagFigcaption : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;figcaption&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagFigcaption(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateFigcaption()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;figcaption&gt;</b> tag
        /// </summary>
        ...
        public TagFigcaption(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
