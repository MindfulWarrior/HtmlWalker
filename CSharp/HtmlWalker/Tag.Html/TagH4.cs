...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;h4&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagH4 : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagH4(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateH4()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;h4&gt;</b> tag
        /// </summary>
        ...
        public TagH4(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
