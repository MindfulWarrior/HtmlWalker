...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;dt&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDt : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagDt(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDt()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;dt&gt;</b> tag
        /// </summary>
        ...
        public TagDt(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
