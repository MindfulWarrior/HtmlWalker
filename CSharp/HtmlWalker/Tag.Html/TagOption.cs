...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;option&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentTextTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagOption : ContentTextTag
    {
        /// <summary>
        ...
        /// </param>
        public TagOption(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateOption()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;option&gt;</b> tag
        /// </summary>
        ...
        public TagOption(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
