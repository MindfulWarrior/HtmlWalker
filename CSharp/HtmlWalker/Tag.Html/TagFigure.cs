...
namespace HtmlWalker.Tag.Html
{
    ...
    public class TagFigure : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagFigure(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateFigure()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;figure&gt;</b> tag
        /// </summary>
        ...
        public TagFigure(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
