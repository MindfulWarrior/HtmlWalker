...
namespace HtmlWalker.Tag.Html
{
    ...
    public class TagTitle : ContentTextTag
    {
        ...
        /// </param>
        public TagTitle(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateTitle()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;title&gt;</b> tag
        /// </summary>
        ...
        public TagTitle(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
