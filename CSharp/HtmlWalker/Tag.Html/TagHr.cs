...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;hr&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentNoneTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagHr : ContentNoneTag
    {
        /// <summary>
        ...
        /// </param>
        public TagHr(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateHr()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;hr&gt;</b> tag
        /// </summary>
        ...
        public TagHr(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
