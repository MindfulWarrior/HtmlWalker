...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;summary&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSummary : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;summary&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagSummary(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSummary()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;summary&gt;</b> tag
        /// </summary>
        ...
        public TagSummary(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
