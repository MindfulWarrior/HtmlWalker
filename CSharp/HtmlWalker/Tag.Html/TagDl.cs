...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;dl&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagDl : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;dl&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagDl(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateDl()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;dl&gt;</b> tag
        /// </summary>
        ...
        public TagDl(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
