...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;aside&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagAside : ContentContainerTag
    {
        /// <summary>
        ///   Constructor for housing a new <b>&lt;aside&gt;</b> tag
        /// </summary>
        /// <param name="factory">
        ///   used to produce the new HTML tag and other objects as per the specific platform
        /// </param>
        public TagAside(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateAside()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;aside&gt;</b> tag
        /// </summary>
        ...
        public TagAside(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
