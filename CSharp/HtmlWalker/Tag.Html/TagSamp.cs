...
{
    /// <summary>
    ///   This class houses the HTML <b>&lt;samp&gt;</b> tag object and provides the <see cref="ITag"/> interface.
    ///   
    ///   Implements <see cref="ContentContainerTag"/>
    /// </summary>
    /// <author>Robert R Flores</author>
    public class TagSamp : ContentContainerTag
    {
        /// <summary>
        ...
        /// </param>
        public TagSamp(WalkerPlatform.WalkerFactory factory) : base(factory, factory.CreateSamp()) { }

        /// <summary>
        ///   Constructor for housing a existing <b>&lt;samp&gt;</b> tag
        /// </summary>
        ...
        public TagSamp(WalkerPlatform.WalkerFactory factory, object tag) : base(factory, tag) { }
